...
Console.WriteLine("2.Conversão de Temperatura(Celsius para Fahrenheit)\n");
...
Console.WriteLine($"\nA temperatura {C}C° em Fahrenheit equivale à: {Math.Round(F, 2)}F°\n");



Console.WriteLine("3. Impressão de Dados do Usuário\n");
...
Console.WriteLine($"\nMeu nome é {nome}, tenho "+ idade + $" anos e moro em {local}\n");
